...
class DistributedGAScheduler:
    ...
    def run_distributed(self):
        ...
        """
        print(f"\n{'='*60}")
        print("Starting Distributed Genetic Algorithm")
        print(f"{'='*60}")
...
if __name__ == "__main__":
    # 使用例
    scheduler = DistributedGAScheduler('large_dataset.xlsx', num_islands=4)
